  ...
  return (
    <section id="cases" className="py-24 md:py-32" ref={ref}>
      <div className="container mx-auto px-6">
        ...
        {/* AI Solutions */}
        <h3 className="text-2xl font-semibold mb-8 text-center font-sans">AI Solutions</h3>
        ...
        <h3 className="text-2xl font-semibold mb-8 text-center font-sans">Blockchain Solutions</h3>
